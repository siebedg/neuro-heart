    ...
    <>
      ...
      >
        <ScrollView contentContainerStyle={{ paddingBottom: 60 }}>
          <Text className="pt-8 text-4xl font-extrabold text-white mb-3">
            The Science
          </Text>
          <Text className="text-white/70 mb-8 text-base leading-relaxed">
            Cortune is more than music. It’s a physiological tool. Designed to
            align heart, mind and rhythm for one goal: optimal human
            performance.
          </Text>

          <BigSection
            icon={<FontAwesome5 name="heartbeat" size={22} color="white" />}
            title="Heart Rate Entrainment"
          >
          ...
          <BigSection
            icon={
              <MaterialCommunityIcons name="pulse" size={22} color="white" />
            }
          ...
          <BigSection
            icon={<Ionicons name="flash" size={22} color="white" />}
            title="Motivation, Self-Belief, and Flow"
          >
          ...
          <BigSection
            icon={<Ionicons name="headset" size={22} color="white" />}
            title="Custom-Made Music"
          >
